...
/// Validates raw signatures with one of the RSA-PSS signature algorithms.
#[non_exhaustive]
...
mod tests {
    ...
    // 512 zero bytes: accepted by rsa::pss::Signature::try_from (only empty slices
    // are rejected); content correctness is checked at verify time, after our
    // guard fires.
